...
func main() {
    router := gin.Default()
    router.GET("/anecdotes", getAnecdote)
    router.GET("/anecdotes/:id", getAnecdoteByID)
    router.POST("/anecdotes", postAnecdote)
    router.PUT("/anecdotes/:id", updateAnecdote)
    router.PATCH("/anecdotes/:id", patchAnecdote)
    router.DELETE("/anecdotes/:id", deleteAnecdoteByID)

    router.POST("/anecdotes/:id/like", likeAnecdote)
    router.POST("/anecdotes/:id/dislike", dislikeAnecdote)
